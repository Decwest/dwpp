...
for method_name in method_name_list:
    ...
    while True:
        ...
        next_velocity, next_velocity_ref, look_ahead_pos = pure_pursuit(current_pose, current_velocity, path, method_name)
...
for method_name in method_name_list:
    ...
    # 速度プロファイルの描画
    draw_velocity_profile(time_stamps, robot_velocities, robot_ref_velocities, method_name, path_name)
